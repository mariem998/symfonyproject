 ...
 */
final class Version20221029011554 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE editor DROP firstname');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE editor ADD firstname VARCHAR(60) NOT NULL');
    }
}
